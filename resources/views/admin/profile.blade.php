            ...
            <div class="col-md-6">
                ...
                <x-card>
                	...
                	<form action="" method="POST">
                		...
                		<x-input type="text" text="Nama Lengkap" name="name" value="{{ auth()->user()->name }}" />

	                	<x-input type="password" text="Kata Sandi Lama" name="old_password" />
	                	<x-input type="password" text="Kata Sandi Baru" name="new_password" />

	                	<div class="text-center">
	                		<x-button type="primary" for="submit" text="Perbaharui Profil" />
	                	</div>
                	</form>
                </x-card>
            </div>
